...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_cookie_parse: string;
	...
	export const NVIM_GTK_NO_HEADERBAR: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_cookie_parse: string;
