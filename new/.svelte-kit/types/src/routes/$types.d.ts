...
type LayoutRouteId = RouteId | '/' | '/collections' | '/collections/[collectionId]' | null;
type LayoutParams = RouteParams & { collectionId?: string };
...
export type PageData = Expand<
	Omit<
		PageParentData,
		keyof Kit.AwaitedProperties<Awaited<ReturnType<typeof import('./+page.js').load>>>
	> &
		OptionalUnion<
			EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('./+page.js').load>>>>
		>
>;
